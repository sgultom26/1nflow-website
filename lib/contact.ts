...
export type ContactValue = { name: string; email: string; message: string; company: string; interest: string };

/** Pure validator shared by the API route and unit tests. */
export function validateContact(data: Record<string, unknown>): { ok: boolean; errors: string[]; value: ContactValue } {
